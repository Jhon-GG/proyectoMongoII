...
function createMovieElement(pelicula) {
    ...
    cardDiv.onclick = () => {
        displayMovieDetails(pelicula.id);
    };
            ...
            <div class="movie-details-container">
                ...
                <section class="second_box">
                    <div class="second_box_content">
                        ...
                        <div class="second_box_right">
                            <button id="myButton" onclick="showTrailerPopup('${movie.trailer}')">
                ...
                <footer class="footer">
                    <div class="footer_button">
                        <button onclick="displaySeatSelection(${movieId})">Comprar Ahora</button>
                    </div>
                </footer>
            </div>
        `;
...
function goToHome() {
    window.location.href = 'index.html'; // Ajusta esto a la ruta correcta de tu página principal
}

function displaySeatSelection(movieId) {
    // Implementa esta función para mostrar la selección de asientos
